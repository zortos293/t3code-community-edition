...
export default function Sidebar() {
  ...
  const currentSplitParam = parseSplitViewRouteSearch(
  ...
  const handleOpenInSplitView = useCallback(
    ...
    [navigate, routeThreadId, currentSplitParam],
  );
    ...
    (
      ...
      if (storedDraftThread) {
        return (async () => {
          ...
          navigateToSingleThread(storedDraftThread.threadId);
        })();
      }
      ...
      return (async () => {
        ...
        navigateToSingleThread(threadId);
      })();
    },
    [
