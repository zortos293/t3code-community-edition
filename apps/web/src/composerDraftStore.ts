...
import { createModelSelection, resolveAppModelSelection } from "./modelSelection";
...
function selectionWithoutOptions(selection: ModelSelection): ModelSelection {
  return createModelSelection(selection.provider, selection.model);
}
        ...
        set((state) => {
          ...
          for (const provider of ["codex", "copilot", "claudeAgent"] as const) {
            ...
            if (opts) {
              ...
              nextMap[provider] = selectionWithoutOptions(current);
            }
          }
      ...
      setProviderModelOptions: (threadId, provider, nextProviderOptions, options) => {
        ...
        set((state) => {
          ...
          if (providerOpts) {
            ...
            nextMap[normalizedProvider] = selectionWithoutOptions(currentForProvider);
          }
          ...
          if (options?.persistSticky === true) {
            ...
            if (providerOpts) {
              ...
              nextStickyMap[normalizedProvider] = selectionWithoutOptions(stickyBase);
            }
